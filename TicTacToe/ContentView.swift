    ...
    var body: some View {
        VStack {
            ...
            Alert(title: Text("Game Over"),
                  message: Text(self.ticTacToeModel.gameOver.0 != .empty ? self.ticTacToeModel.gameOver.0 == .home ? "You Win!": "Enemy Wins!": "Nobody Wins!"), dismissButton: Alert.Button.destructive(Text("Ok"), action: {
